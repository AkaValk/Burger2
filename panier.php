...
session_start();
$items = getItemsFromPanier($_SESSION["user_id"])
?>
<!DOCTYPE html>
<html lang="en">
                                ...
                                <table class="table table-bordered mb-30">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <img src="images/<?php $item["image"]?>" alt="Product" style="width:100px">
                                            </td>
                                            <td>
                                                <a href=""></a><br>
                                            ...
                                            <td>
                                                <div class="quantity"
                                                    ...
                                                    <span id="qtpanier"><?=$item["qte"]?></span>
                                                    <a href=""
                                                        style="border:none; background-color:white; text-decoration:none;  color:black">
                                                        <span
